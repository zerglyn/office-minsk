...
To use these stylesheets, rename the files and ice_dev with the name of your theme.
...
ice_dev-alpha-default-narrow.css  
...
ice_dev-alpha-default-normal.css
...
ice_dev-alpha-default-wide.css
